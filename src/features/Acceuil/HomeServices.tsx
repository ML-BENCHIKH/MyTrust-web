...
export default function HomeServices() {
    return (
        <section
            className="relative w-[96vw] md:h-[calc(100vh-7rem)] px-1 py-3 mt-4 md:mt-0 md:w-full flex flex-col items-center justify-center md:py-18 overflow-hidden bg-white md:bg-gradient-to-br from-white via-white to-orange-200/60">
